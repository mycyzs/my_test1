controllers.controller("test", ["$scope", "loading", "$modal", "confirmModal", "sysService", "errorModal", "msgModal", function ($scope, loading, $modal, confirmModal, sysService, errorModal, msgModal) {
    ...
    $scope.gridOption = {
        ...
        columnDefs: [
            {field: "name", displayName: "模板名称", width: 160},
            {field: "biz_name", displayName: "业务名称", width: 140},
            {field: "script", displayName: "脚本内容", width: 180},
            {field: "max_num", displayName: "阈值", width: 160},
            {field: "create_time", displayName: "创建时间", width: 160},
